        ...
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div class="bg-white  shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-col justify-center items-center">
                    <div class="flex flex-col justify-center items-center" x-data="{Headings:false, Messengers:false }">
...
ss
                        ...
                        <div x-show='Headings' @click.outside="Headings = false" style="display: none"
                        ...
                        <div x-show='Messengers' @click.outside="Messengers = false" style="display: none"
                             class=" bg-white p-8 w-[100%] md:w-[45.6%] absolute bottom-0 rounded-t-3xl "
                             x-transition:enter="transition origin-top ease-out duration-300"
                             x-transition:enter-start="transform translate-y-full opacity-0"
                             x-transition:enter-end="transform translate-y-0 opacity-100"
