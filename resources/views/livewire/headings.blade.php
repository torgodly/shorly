<div class="">
    ...
    <div class="mt-10 space-y-5">
        <input wire:model="title" type="text" name="text"  class="block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm placeholder-[#666666] md:text-xl" placeholder="Title">
        <textarea wire:model="description" class="block w-full h-16 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm placeholder-[#666666] md:text-xl" placeholder="Description"></textarea>
    </div>
</div>
