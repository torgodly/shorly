<div>
    ...
    <div class="flex  justify-between items-center space-y-2 sm:space-y-0 sm:space-x-2">
        <select class="px-4 py-2 border rounded-md shadow-sm text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" wire:model="scope">
        ...
        <div date-rangepicker datepicker-buttons datepicker-format="yyyy-mm-dd" class="flex items-center">
            <div class="relative">
                ...
                <input id="startDate" name="start" wire:model="startDate" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
            </div>
            ...
            <div class="relative">
                ...
                <input id="endDate" name="end" wire:model="endDate" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
            </div>
        </div>
...
{{--        <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.6.4/datepicker.min.js"></script>--}}
    ...
    <div>
        ...
        <h1 class="font-medium">Total Visitors: <span>{{$total}}</span></h1>
    </div>
